...
export function exerciseFitApplicationResult({ movement, height, armSpan, femur, tibia }, language='th') {
  ...
  if (movement === 'BENCH') {
    ...
    return {
      ...
      watch: th
        ? 'Ape Index อย่างเดียวไม่สามารถตัดสินว่า Barbell, Dumbbell หรือ Machine แบบไหนดีที่สุดสำหรับคุณ'
  ...
  return {
    ...
    watch: th ? 'Femur:Tibia อย่างเดียวไม่สามารถตัดสินว่า Front หรือ Back Squat เหมาะกว่าคุณ' : 'Femur:Tibia alone cannot decide whether Front or Back Squat is better for you.',
