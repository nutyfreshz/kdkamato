...
export default async function ProgramStartPage() {
  ...
  return <AppShell>
    <div className="topline">ตั้งค่าโปรแกรม</div>
    <h1>ตั้งค่าโปรแกรมฝึก</h1>
    <p>เลือกเป้าหมาย จุดเน้น จำนวนวันฝึก ประสบการณ์ อุปกรณ์ และเวลาฝึกต่อครั้ง ระบบจะใช้ข้อมูลเหล่านี้สร้างตัวอย่างให้คุณดูก่อนเปิดใช้</p>
