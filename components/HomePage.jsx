...
const copy = {
  th: {
    heroTitle: <>สิ่งที่คุณเห็น<br/>คือเพียง<br/><span>ปลายทาง.</span></>,
    heroLede: 'เบื้องหลังร่างกายที่เปลี่ยนไป มีทั้งการฝึก สัญญาณ การตอบสนองของเซลล์ โภชนาการ และการฟื้นตัว',
    enter: 'เข้าไปดูว่าเกิดอะไรขึ้นข้างใน',
    ...
    labTitle: <>ลองกับ<br/>ข้อมูลของคุณ</>, labIntro: 'เริ่มจากคำถามที่อยากรู้ กรอกข้อมูลที่วัดได้ แล้วดูว่ามันเปลี่ยนการจัดท่า สัดส่วน หรือการตีความอย่างไร โดยไม่ต้องรู้ศัพท์มาก่อน',
    c1: 'ทำไมบางท่ารู้สึกไม่เข้ากับโครงคุณ?', c2: 'Squat แบบไหนควรลองก่อน?', c3: 'อยากให้หุ่นดู V ขึ้น ควรพัฒนาอะไร?',
