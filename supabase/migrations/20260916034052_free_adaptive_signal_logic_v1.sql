...
begin
  ...
  select coalesce(pe.new_issue,false), pe.adherence_status
    into v_latest_issue, v_latest_adherence
  from public.progress_entries pe
  ...
  elsif v_latest_adherence = 'LOW' then
  ...
  loop
    ...
    elsif v_global_code in ('HOLD_RECOVERY','HOLD_SESSION') then
